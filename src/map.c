...
/*   Updated: 2025/03/28 19:58:38 by mbany            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void draw_map(t_game *game)
{
    ...
    int offset_y = 10;   
    int floor_color = game->color_floor;
    int celing_color = game->color_ceiling;
