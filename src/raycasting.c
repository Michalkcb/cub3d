...
static void calculate_ray(int x, int w, double dirX, double dirY,
                          double planeX, double planeY,
                          double *cameraX, double *rayDirX, double *rayDirY)
{
...
static void compute_delta_distances(double rayDirX, double rayDirY,
